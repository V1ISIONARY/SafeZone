...
class SafeZoneStatusHistory extends StatefulWidget {
  const SafeZoneStatusHistory({super.key, required this.safezonemodel});
  final SafeZoneModel safezonemodel;

  @override
  State<SafeZoneStatusHistory> createState() => _SafeZoneStatusHistoryState();
}

class _SafeZoneStatusHistoryState extends State<SafeZoneStatusHistory> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: const CategoryText(text: "Safe Zone Status History"),
      ),
      body: Container(
                    ...
                    endChild: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            "Remarks: $remarksText",
                            style: const TextStyle(fontSize: 13, color: labelFormFieldColor),
                          ),
                          const SizedBox(height: 4),
                          Text(
