...
import 'package:safezone/resources/schema/colors.dart' show labelFormFieldColor, textColor, widgetPricolor;
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 5),
                  Flexible(
                    child: Text("Your new password must be different from any of your previously used passwords to enhance security and protect your account.",
                  ...
                  GestureDetector(
                    onTap: (){
                      ...
                      if (newPassword.isEmpty ||
                        ...
                        setState(() {
                          _checkIfShown(text: "All fields are required", color: Colors.red);
                        });
