...
class ReportsHistoryDetailsDT extends StatefulWidget {
  ...
  @override
  State<ReportsHistoryDetailsDT> createState() => _ReportsHistoryDetailsDTState();
}
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            CategoryDescripText(
                              text: reportStatusMessage(widget.reportInfo.status!),
                              color: Colors.white,
                            ),
                          ],
                        ),
                        ...
                        child: Column(
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                widget.reportInfo.dangerZone?.name ?? "Incident Report",
                                style: const TextStyle(
                                  fontSize: 15,
                                  color: Colors.black
                                ),
